...
OBJECTS_SAMPLER = $(BUILD_DIR_SAMPLER)/Main.o $(BUILD_DIR_SAMPLER)/TcpServer.o $(BUILD_DIR_SAMPLER)/TcpConnection.o $(BUILD_DIR_SAMPLER)/RbufferManager.o $(BUILD_DIR_SAMPLER)/Statistics.o $(BUILD_DIR_SAMPLER)/InputManager.o $(BUILD_DIR_SAMPLER)/TcpClient.o
